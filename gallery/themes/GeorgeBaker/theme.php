...
// Modified by Mike Medley - all changes documented, search for "Mike Medley"
...
// Mike Medley REMOVED SORT FEATURES FROM THIS TABLE
// HTML template for title row of the thumbnail view (album title + sort options)
$template_thumb_view_title_row = <<<EOT

                        <table width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                                <td width="100%" class="statlink"><h2 class="gallery">{ALBUM_NAME}</h2></td>
                        </tr>
                        </table>
...
// Mike Medley removed the picinfo function here 
...
// Mike Medley modified the page background and font, the body margins, and image border.
...
<html>
  ...
  <style type="text/css">
  body { margin: 0; padding: 25px 0px 0px 0px; background-color: #e0d4ca; color: #000000; font-size: 75%;}
  img { margin: 0px 25px 25px 25px; padding: 0; border: 19px solid #f9f6ed; }
  ...
  <body>
    ...
    <table>
      <tr>
            <td>
          <div id="content">
              <p>Click on the image to close this window.</p>
